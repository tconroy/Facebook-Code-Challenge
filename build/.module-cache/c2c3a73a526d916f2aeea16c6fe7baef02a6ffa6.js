...
var Calendar = React.createClass({displayName: "Calendar",
  ...
  componentDidMount: function() {
    this.setState( {calEvents: SAMPLE_EVENTS} );
  },
  render: function() {
    return (
      React.createElement("div", null, 
      this.state.calEvents.map(function(item, i){
...
var cal = React.render( React.createElement(Timeline, {times: TIME_OPTS}), document.getElementById('timeline') );
