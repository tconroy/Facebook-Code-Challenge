...
var Calendar = React.createClass({displayName: "Calendar",
  render: function() {
    ...
    var el = [];
    el.push( React.createElement(Timeline, {times: this.prop.times}) );
    this.prop.calEvents.map(function(item){
      el.push( React.createElement(Event, {start: item.start, end: item.end}) );
    });
