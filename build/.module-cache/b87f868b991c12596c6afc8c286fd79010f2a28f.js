...
var Calendar = React.createClass({displayName: "Calendar",
  ...
  detectSiblings: function( oldEventArr ) {
    ...
    // console.dir( oldEventArr );
    // console.log( typeof oldEventArr );
    // for ( var i=0; i<n; i++ ) {
    //   newEventArr.push( oldEventArr[i] );
    // }
    // return newEventArr;
    console.log(typeof newEventArr);
    newEventArr = oldEventArr.map(function(item, i) {
      return item;
    });
