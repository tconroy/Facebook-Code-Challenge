  ...
  render: function() {
    ...
    return (
      ...
      calEvents.map(function(item, i){
          return( React.createElement(Event, {key: i, top: item.start, siblings: item.siblings, width:  100 / item.siblings, height:  item.end - item.start}) );
      })
      )
    );
  }
...
var Event = React.createClass({displayName: "Event",
  render: function() {
    ...
    var eventStyle = {
      top: this.props.top,
      left: (this.props.width * this.props.siblings) + '%',
