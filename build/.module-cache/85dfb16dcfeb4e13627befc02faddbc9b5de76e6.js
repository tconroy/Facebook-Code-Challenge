  ...
  render: function() {
    return (
      React.createElement("div", null, 
        ...
        this.props.calEvents.map(function(calEvent){
          return ( React.createElement(Event, {start: calEvent.start, end: calEvent.end}) ) ;
        })
      )
    );
  }
...
var Event = React.createClass({displayName: "Event",
  render: function() {
    return (React.createElement("div", {key: this.prop.start, className: "events"}, this.prop.start, ", ", this.prop.end));
  }
});
